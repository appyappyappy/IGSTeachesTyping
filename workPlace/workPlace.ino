...
void setup() {
  ...
  BLE.setLocalName("Team Insoniacs");
...
void bluetooth(){
  ...
  if (central) {
    ...
    Serial.println(central.address());
    digitalWrite(LED, LOW);         // will turn the LED off
  }
}
...
int melody[] = {
  ...
  NOTE_D5, 4, REST, 8, NOTE_CS5, 8, REST, 4, 
  NOTE_C5, 4, NOTE_AS6, 4, NOTE_GS5, 8, NOTE_G5, 8, 
  NOTE_C5, 4, NOTE_C5, 4, REST, 4,

   NOTE_D5, 4, REST, 8, NOTE_CS5, 8, REST, 4, 
  NOTE_C5, 4, NOTE_AS6, 4, NOTE_GS5, 8, NOTE_G5, 8, 
  NOTE_C5, 4, NOTE_C5, 4, REST, 4,

  NOTE_D5,4, REST,4,NOTE_A5, 4, NOTE_D4,4,
};
